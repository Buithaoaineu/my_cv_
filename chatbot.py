...
st.set_page_config(page_title="My Slay Chatbot", page_icon="🤖", layout="wide")
...
def main():
    ...
    ##### CODE SNIPPET START #####
    with st.sidebar: #hiện ở bên trái trang
        st.header("⚙️ Cài đặt")
        ...
        context_text = st.text_area(
            ...
            height =150,
            placeholder = "Nhập thông tin hướng dẫn cho AI tại đây...",
        ...
        st.button("Xóa cuộc trò chuyện", key = "clear_chat")
